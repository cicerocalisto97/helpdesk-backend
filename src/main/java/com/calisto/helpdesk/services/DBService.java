...
public class DBService {
	...
	public void instanciaDB() {
		...
		Chamado c1 = new Chamado(null, Prioridade.MEDIA, Status.ANDAMENTO, "Troca de Fonte de notebook", "Manutenção", "Trocar fonte de notebook", tec1, cli1);
		Chamado c2 = new Chamado(null, Prioridade.ALTA, Status.ABERTO, "Instalar Windows 10 em desktop", "Formatação", "Formatar com Windows 10", tec1, cli2);
		Chamado c3 = new Chamado(null, Prioridade.BAIXA, Status.ENCERRADO, "Instalar Antivírus Avast", "Manutenção", "Instalar Avast no PC", tec2, cli3);
		Chamado c4 = new Chamado(null, Prioridade.ALTA, Status.ABERTO, "Troca de HD", "Manutenção", "Trocar HD queimando por um novo", tec3, cli3);
		Chamado c5 = new Chamado(null, Prioridade.MEDIA, Status.ANDAMENTO, "Montar PC", "Montagem", "Montar micro com tecnologia AMD", tec2, cli1);
		Chamado c6 = new Chamado(null, Prioridade.BAIXA, Status.ENCERRADO, "Vender PC", "Venda", "Colocar PC para venda", tec1, cli5);
